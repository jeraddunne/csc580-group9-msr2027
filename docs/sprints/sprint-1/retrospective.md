...
Paste the Sprint 1 rows from `docs/lean-six-sigma/metrics/DASHBOARD.md`. Compare against the targets in `docs/lean-six-sigma/KPIS.md`.
...
- Why 5:
- Root cause:
- Waste category (see `docs/lean-six-sigma/WASTE_LOG.md`):
...
|---|---|---|---|---|
| Research question | | | | ADR / `RESEARCH_QUESTION.md` |
| Method | | | | |
| Scope | | | | |
| Interpretation | | | | |
| Backlog (added / removed / re-estimated) | | | | Milestone `Sprint 2` |
