...
Paste the Sprint 2 rows from `docs/lean-six-sigma/metrics/DASHBOARD.md` next to Sprint 1.

| KPI | Target | Sprint 1 | Sprint 2 | Trend | In control? |
|---|---|---|---|---|---|
