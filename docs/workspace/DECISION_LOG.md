...
| D-022 | 2026-09-23 | Lineage and signals validation is done by Jerad Dunne alone: round 1, then a round 2 on the kit's 30% intra-rater subset at least 14 days later without looking at round 1; intra-rater kappa is reported for those kinds. Drift keeps inter-rater kappa between `jd` and `la`. Allie Hodges and Hina Kramer stay in the group; their unsigned charter rows and missing onboarding are recorded in `TEAM_CHARTER.md` section 14 | Agreed (2026-09-23, Jerad Dunne) | Decision by the repository owner | No teammate claimed lineage or signals in #53, and two members have not contributed since onboarding; the second-rater deadline is 2026-10-16 | #53; `docs/validation/README.md`; `TEAM_CHARTER.md` section 14; revises D-020 | A teammate commits labels for lineage or signals, which would restore inter-rater kappa for that kind |
