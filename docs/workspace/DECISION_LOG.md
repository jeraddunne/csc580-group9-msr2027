...
| D-013 | 2026-09-14 | Run the project as a solo project; Jerad Dunne holds every Scrum role | Agreed (2026-09-14, sole member; solo project confirmed as permitted) | Solo conversion | Decision by the student; the assignment states groups of three to five | [ADR-0005](../decisions/ADR-0005-solo-execution.md) | No instructor confirmation by 2026-10-07, or instructor asks for a group |
| D-014 | 2026-09-14 | Self-review protocol: every change by pull request, self-review after at least 12 hours with the PR checklist, CI green once enabled, optional external review on major PRs; `main` ruleset requires a PR with 0 approvals | Agreed (2026-09-14, sole member; solo project confirmed as permitted) | Solo conversion | Substitute for cross-member review | ADR-0005, TEAM_CHARTER.md section 7 | Defects escape review twice in one sprint |
| D-015 | 2026-09-14 | Validation reliability through intra-rater agreement (re-label a random 30% at least 7 days later, Cohen's kappa) plus an optional second rater; an LLM rater is disclosed and never counted as human agreement | Agreed (2026-09-14, sole member; solo project confirmed as permitted) | Solo conversion | Substitute for two independent annotators | ADR-0005, `docs/validation/` | Intra-rater kappa below 0.6 |
...
| D-017 | 2026-09-14 | Validation round 1 starts 2026-09-14 instead of 2026-10-08; the round 2 intra-rater re-label happens no earlier than 2026-09-21; scoring follows round 2 | Agreed (2026-09-14, sole member) | Request by Jerad Dunne | Validated precision early reduces risk for Sprint 2 and the report | `docs/validation/README.md` | A rule changes after round 1 (re-sample the affected strata) |
